...
\begin{figure}
    \centering
       \subfigure[Profile in $t$]{\includegraphics{Figures/BC_wave.pdf}}
	\subfigure[Profile in $z$]{\includegraphics[height = 2in]{Figures/inv_rw}}     
...
\begin{figure}
  \centering
  \subfigure[box]{\includegraphics{Figures/char_box.pdf}}
  \subfigure[triangle]{\includegraphics{Figures/char_tri.pdf}}
  \subfigure[N]{\includegraphics{Figures/char_N.pdf}}
  \caption{}
  \label{fig:chars2}
\end{figure}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[height = 3in]{Figures/expt_setup}}
\subfigure[]{\includegraphics[height = 3in]{Figures/conduit.png}}
...
\begin{figure}
\centering
\subfigure[]{ \includegraphics[height = 2.5in]{Figures/BreakHeight.pdf}}
...
\begin{figure}
\centering
\subfigure[]{ \includegraphics[height = 2.5in]{Figures/BreakTime.pdf}}
